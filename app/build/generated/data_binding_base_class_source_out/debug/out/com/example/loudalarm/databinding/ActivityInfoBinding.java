...
public final class ActivityInfoBinding implements ViewBinding {
  ...
  private ActivityInfoBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton backBtn,
      @NonNull LinearLayout indicatorLayout, @NonNull TextView nameOfChangedTheme,
      @NonNull ImageButton nextbtn, @NonNull ImageButton skipButton,
  ...
  public static ActivityInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityInfoBinding((ConstraintLayout) rootView, backBtn, indicatorLayout,
          nameOfChangedTheme, nextbtn, skipButton, slideViewPager);
    }
